...
<div id="content" class="app-content">
	...
	<h1 class="page-header d-flex justify-content-between">
		Party 
		<button type="button" class="btn btn-outline-theme me-2 add-party">Add Party</button>
	...
	<div id="datatable" class="mb-5">
		...
		<div class="card">
			<div class="card-body">
				<table id="party" class="table text-nowrap w-100">
					<thead>
						<tr>
							<th>#</th>
							<th>Name</th>
...
<!-- END #content -->
<?php include(APPPATH . 'Views/modals/party-modal.php') ?>