		...
		<div class="modal fade payable-modal" id="item-modal">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title">Add Payable</h5>
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-md-6 mb-3">
								<input type="hidden" class="payable_id">
							...
							<div class="col-md-12 mb-3">
								<label for="payable_desc" class="form-label">Description</label>
								<textarea type="textarea" class="form-control payable_desc"  placeholder="Description" id="payable_desc" rows="5" value=""required></textarea>
							</div>
