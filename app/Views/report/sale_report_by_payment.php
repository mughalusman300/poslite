...
<div id="content" class="app-content">
    ...
    <div id="datatable" class="mb-5">
        ...
        <div class="card">
            <div class="card-body">
                <form id="report" action="<?=URL?>/report/sale_report_by_payment" method="POST" class="report">
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <tbody>
                            <?php if(!empty($report_data)) { ?>
                                <?php foreach ($report_data as $row) { ?>
                                    ...
                                    <?php $detail = $this->Reportmodel->getSalesReportByPayment(date('Y-m-d', strtotime($row->invoice_date))); ?>
                                    <?php if(!empty($detail)) { 
