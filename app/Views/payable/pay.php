...
<div id="content" class="app-content">
	...
	<div id="datatable" class="mb-5">
		...
		<div class="card">
				...
				<table id="expense" class="table table-bordered text-nowrap w-100 mt-2">
				    ...
				    <tbody>
				    	<tr>
				    		...
				    		<td><?= number_format($payable->amount, 2) ?>
					...
					<table id="previous_details" class="table table-bordered text-nowrap w-100 mt-2">
					    <thead>
					        <tr>
					            ...
					            <?php if($type != 'view' && in_array('alter_payable_pay', $_SESSION['permissions']) ) { ?>
					    	...
					    	<?php if ($paid) { ?>
								<?php foreach ($paid as $row) { ?>
								        ...
								        <tr class="previous_detail_row">
								            <td>
								            	<input type="hidden" class="payable_detail_id" value="<?= $row->payable_detail_id ?>" >
								            ...
								            <td>
								            	<div class="show payable_detail_desc_text">
								                	<?= htmlspecialchars($row->payable_detail_desc) ?>
								                </div>
								                <div class="update" style="display: none">
								                	<textarea type="textarea" class="form-control payable_detail_desc"  placeholder="Description" id="payable_detail_desc" rows="2"><?= $row->payable_detail_desc ?></textarea>
								                </div>
								            </td>
								            <td class="text-center">
								            	<div class="show payable_detail_amount_text">
								                	<?= number_format($row->payable_detail_amount, 2) ?>
									            </div>
								                <input type="hidden" 
								                	class="amount" 
									            ...
									            <div class="update" style="display: none; width: 100px;">
									            	<input type="text" data-old_val= "<?= $row->payable_detail_amount ?>" class="form-control validate-input payable_detail_amount twodecimel" placeholder="0.00" id="payable_detail_amount" value="<?= $row->payable_detail_amount ?>" >
									            </div>
								            </td>
								            <td class="text-center">
								                <div>
			...
			<?php if($type == 'pay' && in_array('alter_payable_pay', $_SESSION['permissions'])) { ?>
					...
					<div class="card-body">
						...
						<div class="parent-row">
							<div class="row main-row mb-3 main-first-row">
								...
								<div class="col-md-2">
									<label for="payable_detail_amount" class="form-label">Amount</label> <span class="color-red">*</span>
									<input type="text" class="form-control validate-input payable_detail_amount twodecimel" placeholder="0.00" name="payable_detail_amount[]" id="payable_detail_amount" value="" >
								</div>

								<div class="col-md-3">						
									<label for="payable_detail_desc" class="form-label">Description</label>
									<textarea type="textarea" name="payable_detail_desc[]" class="form-control payable_detail_desc"  placeholder="Description" id="payable_detail_desc" rows="2" value=""></textarea>
								</div>
								<div class="col-md-1">
					...
					<div class="card-footer bg-none fw-bold">
						<div class="row">
							<div class="col-md-12" style="display: flex;justify-content: end">	
								<a type="button" href="<?= URL?>/payable" class="btn btn-outline-theme me-2"> <i class="fas fa-fw fa-arrow-left"> </i>Go Back</a>
