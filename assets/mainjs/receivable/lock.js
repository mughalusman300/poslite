$(document).ready(function() {
    ...
    $(document).on('click',".update-status",function (e) {
    	...
    	var receivable_detail_id = selector.attr('data-receivable_detail_id');
    	...
    	Swal.fire({
    	  ...
    	  confirmButtonText: 'Yes, do it!'
    	  	...
    	  	if (result.isConfirmed) {
    	  		$.ajax({
    	  			url: base + "/receivable/update_satus",
    	  			type: "POST",
    	  			data: {receivable_detail_id: receivable_detail_id, type: type},        
          ...
          confirmButtonText: 'Yes, do it!'
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: base + "/receivable/update_satus",
                    type: "POST",
                    data: {receivable_detail_id: receivable_detail_id, type: 'revert'},        
                    success: function(data) {
                        if (data.success) {
    ...
    $(document).on('click',".complete",function (e) {
        var selector = $(this);
        var receivable_id = selector.attr('data-receivable_id');
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.success) {
                            ...
                            setTimeout(function(){
                                let url = base + "/receivable/completed";
                                window.location = url
                            },1500);
